...
public class GithubUtils {
    ...
    private static final String API_LATEST_RELEASE = API_BASE + "TerraByteDev/HoloMobHealth-PacketEvents/releases/latest";

    // https://docs.github.com/en/rest/commits/commits#compare-two-commits
    private static final String API_COMPARE = API_BASE + "TerraByteDev/HoloMobHealth-PacketEvents/compare/%s...%s";
