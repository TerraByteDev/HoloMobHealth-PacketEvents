...
public class ChatUtils {
    ...
    public static final String PREFIX = "<gray>[<reset><b><gradient:#0836FB:#00B6FF>HoloMobHealth-PacketEvents</gradient></b><gray>]<reset>";

    static {
        audience = BukkitAudiences.create(HoloMobHealthPacketEvents.instance);
    }
